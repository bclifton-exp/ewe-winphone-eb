...
namespace Expedia.Services.Interfaces
{
    public interface IAuthenticationService
    {
        ...
        Task<SignInResponse> SignIn(CancellationToken ct, string email, string password);
        Task<FacebookAccount> SignInWithFacebook(CancellationToken ct, string accessToken);
        Task<SignInResponse> CompleteSignInWithFacebook(CancellationToken ct, FacebookAccount account, string expediaEmail = null, string expediaPassword = null);
        void SignOut();
    }
}
